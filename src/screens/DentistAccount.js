...
export default class DentistAccount extends Component {
  ...
  myClientList() {
    this.props.navigation.navigate('MyClientList');
  }
  ...
  render() {
    ...
    return (
      <View style={css.container}>
        ...
        <TouchableOpacity onPress={() => this.subscripitonPage()}>
          <View style={css.other_row}>
            <Text allowFontScaling={false} style={css.text_title_tag}>
              Subscription
            </Text>
        ...
        {/* <TouchableOpacity onPress={() => this.myClientList()}>
          <View style={css.other_row}>
            <Text allowFontScaling={false} style={css.text_title_tag}>My Client List</Text>
        ...
        <View style={css.titleAndVersionContainerStyle}>
          ...
          <View allowFontScaling={false} style={css.versionContainerStyle}>
            {Platform.OS == 'android' ? (
