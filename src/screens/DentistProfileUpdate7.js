    ...
    xhr.addEventListener("readystatechange", function () {
      if (this.readyState === 4) {
        if (this.responseText.indexOf('status') !== -1) {
          ...
          if (obj.status == 1) {
            mThis.setState({
              dentistLanguage: obj.languages,
              dentistPersonalStatement: obj.dentist_lang_details.docs_language.personal_statement
            })
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={styles.profileImage}>
            ...
            <Text style={{ color: constants.baseColor, fontSize: 22, marginBottom: 15 }} >Personal Statement</Text>

          </View>
          <View style={{ flexDirection: 'column', alignItems: 'center' }}>
            <Text style={{ color: constants.baseColor, fontSize: 19, marginTop: 10 }}>Languages</Text>
          </View>
          <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>{this.state.dentistLanguage.map((item, index) =>
            (
          ...
          <View >
            <View style={{ flexDirection: 'column', alignItems: 'center' }}>
              <Text style={{ color: constants.baseColor, fontSize: 19, marginTop: 10 }}>Personal Statement</Text>
            </View>
            <Text
              allowFontScaling={false}


              style={{ flex: 1, flexWrap: 'wrap', fontSize: 18 }}
          ...
          <TouchableOpacity style={{ marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: constants.baseColor, borderRadius: 10, height: 50, width: '50%', marginLeft: '25%' }} onPress={() => { this.props.navigation.navigate('dentistAccount') }}>
