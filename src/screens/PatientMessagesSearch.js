...
export default class PatientMessagesSearch extends Component {
  ...
  static navigationOptions = {
    ...
    tabBarIcon: ({ tintColor }) => (
      <Image style={{ width: 30, height: 30 }} source={tintColor == constants.baseColor ? require('../images/n3-on.png') : require('../images/n3-off.png')} />
    ),
  }
  ...
  mUnreadChatCountForPatient() {
    ...
    xhr.open("POST", 'https://dentalchat.com/server/unread-chat-count-for-patient');
    xhr.send(data);
  }
