    ...
    xhr.addEventListener("readystatechange", function () {
      if (this.readyState === 4) {
        if (this.responseText.indexOf('status') !== -1) {
          ...
          if (obj.status == 1) {
            mThis.setState({
              dentistSkills: obj.dentist_skills
            })
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={styles.profileImage}>
            ...
            <Text style={{ color: constants.baseColor, fontSize: 22, marginBottom: 15 }} >Specialties</Text>
          ...
          <TouchableOpacity style={{ marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: constants.baseColor, borderRadius: 10, height: 50, width: '50%', marginLeft: '25%' }} onPress={() => { this.props.navigation.navigate('dentistProfileUpdate5') }}>
            <Text style={{ color: 'white' }}>Back</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: constants.baseColor, borderRadius: 10, height: 50, width: '50%', marginLeft: '25%' }} onPress={() => { this.props.navigation.navigate('dentistProfileUpdate7') }}>
