...
export default class DentistForgotPassword extends Component {
  ...
  mForgetpassword() {
    ...
    xhr.open("POST", constants.url + "service/forgot-password");
    xhr.send(data);
  }
  ...
  mFailed() {
    this.setState({ visible: false }, () => {
      setTimeout(() => {
        Alert.alert('Failed', 'Please provide valid email address');
      }, 200);
    });
  }
