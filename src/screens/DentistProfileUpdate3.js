      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={styles.profileImage}>
            ...
            <Text style={{ color: constants.baseColor, fontSize: 22, marginBottom: 15 }} >Education And Training</Text>

          </View>
          <View style={{ flexDirection: 'column', alignItems: 'center' }}>
            <Text style={{ color: constants.baseColor, fontSize: 19, marginTop: 10 }}>Education</Text>
          </View>{this.state.dentistEducation.map((item, index) =>
            (
              <View>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center' }}>
            <Text style={{ color: constants.baseColor, fontSize: 19, marginTop: 10 }}>Awards & Publication</Text>
          </View>{this.state.dentistAward.map((item, index) =>
            (
              <View>
                <View style={styles.editView}>
                  <View style={styles.searchSection}>
                    <Text style={{ marginLeft: 10, color: constants.baseColor, fontSize: 18 }}>{index + 1}</Text>
                    <TextInput
                      allowFontScaling={false}
                      value={item.award}
                      keyboardType='default'
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center' }}>
            <Text style={{ color: constants.baseColor, fontSize: 19, marginTop: 10 }}>In Network Insurance</Text>
          </View>{this.state.dentistInsurance.map((item, index) =>
            (
              <View>
                <View style={styles.editView}>
                  <View style={styles.searchSection}>
          ...
          <TouchableOpacity style={{ marginTop: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: constants.baseColor, borderRadius: 10, height: 50, width: '50%', marginLeft: '25%' }} onPress={() => { this.props.navigation.navigate('dentistProfileUpdate2') }}>
